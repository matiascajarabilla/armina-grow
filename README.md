...
Este es un ejercicio de programación utilizando Gemini IA modelo 2.5 Pro (preview). Mis conocimientos de programación son escasos: algo de Python, algo de HTML y CSS, estructuras básicas.
...
- [Módulo ESP32](https://www.theengineeringprojects.com/2020/12/esp32-pinout-datasheet-features-applications.html)
...
- [Fuente para breadbord](https://protosupplies.com/product/ywrobot-breadboard-power-supply/)
